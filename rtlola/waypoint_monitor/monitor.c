...
verdict.motor_check = motor_check_sync(memory);verdict.motor_check_is_present = 1;
}
if (motor_failed_is_fresh(memory)) {
verdict.motor_failed = motor_failed_sync(memory);verdict.motor_failed_is_present = 1;
}
...
verdict.battery_failed = battery_failed_sync(memory);verdict.battery_failed_is_present = 1;
}
...
verdict.battery_low = battery_low_sync(memory);verdict.battery_low_is_present = 1;
}
