#include <stdbool.h>
char* STR_CONSTANT_0 = "X drift exceeded 5 cm! Correcting position!";
char* STR_CONSTANT_1 = "Y drift exceeded 5 cm! Correcting position!";
char* STR_CONSTANT_2 = "Z drift exceeded 5 cm! Correcting position!";
char* STR_CONSTANT_3 = "Pitch exceeded 0.3 radians! Stabilizing!";
char* STR_CONSTANT_4 = "Roll exceeded 0.3 radians! Stabilizing!";
char* STR_CONSTANT_5 = "Yaw exceeded 0.3 radians! Stabilizing!";
typedef struct {
double values[1];
bool valid[1];
int current;
