...
double abs_multi_ranger_x_drift_sync(Memory* memory){
return memory->boundedbuffer_abs_multi_ranger_x_drift.values[memory->boundedbuffer_abs_multi_ranger_x_drift.current];
}
double abs_multi_ranger_y_drift_sync(Memory* memory){
return memory->boundedbuffer_abs_multi_ranger_y_drift.values[memory->boundedbuffer_abs_multi_ranger_y_drift.current];
}
double abs_multi_ranger_z_drift_sync(Memory* memory){
return memory->boundedbuffer_abs_multi_ranger_z_drift.values[memory->boundedbuffer_abs_multi_ranger_z_drift.current];
}
...
bool multi_ranger_x_drift_exceeded_sync(Memory* memory){
return memory->boundedbuffer_multi_ranger_x_drift_exceeded.values[memory->boundedbuffer_multi_ranger_x_drift_exceeded.current];
}
char* trigger_3_sync(Memory* memory){
return memory->boundedbuffer_trigger_3.values[memory->boundedbuffer_trigger_3.current];
}
bool multi_ranger_y_drift_exceeded_sync(Memory* memory){
return memory->boundedbuffer_multi_ranger_y_drift_exceeded.values[memory->boundedbuffer_multi_ranger_y_drift_exceeded.current];
}
char* trigger_4_sync(Memory* memory){
return memory->boundedbuffer_trigger_4.values[memory->boundedbuffer_trigger_4.current];
}
bool multi_ranger_z_drift_exceeded_sync(Memory* memory){
return memory->boundedbuffer_multi_ranger_z_drift_exceeded.values[memory->boundedbuffer_multi_ranger_z_drift_exceeded.current];
}
...
bool abs_multi_ranger_x_drift_is_fresh(Memory* memory){
return memory->boundedbuffer_abs_multi_ranger_x_drift.is_fresh;
}
bool abs_multi_ranger_y_drift_is_fresh(Memory* memory){
return memory->boundedbuffer_abs_multi_ranger_y_drift.is_fresh;
}
bool abs_multi_ranger_z_drift_is_fresh(Memory* memory){
return memory->boundedbuffer_abs_multi_ranger_z_drift.is_fresh;
}
...
bool multi_ranger_x_drift_exceeded_is_fresh(Memory* memory){
return memory->boundedbuffer_multi_ranger_x_drift_exceeded.is_fresh;
}
bool trigger_3_is_fresh(Memory* memory){
return memory->boundedbuffer_trigger_3.is_fresh;
}
bool multi_ranger_y_drift_exceeded_is_fresh(Memory* memory){
return memory->boundedbuffer_multi_ranger_y_drift_exceeded.is_fresh;
}
bool trigger_4_is_fresh(Memory* memory){
return memory->boundedbuffer_trigger_4.is_fresh;
}
bool multi_ranger_z_drift_exceeded_is_fresh(Memory* memory){
return memory->boundedbuffer_multi_ranger_z_drift_exceeded.is_fresh;
}
...
void eval_abs_multi_ranger_x_drift_0(Memory* memory){
double new_value = ((multi_ranger_x_drift_sync(memory) < 0)?(-multi_ranger_x_drift_sync(memory)):multi_ranger_x_drift_sync(memory));
memory->boundedbuffer_abs_multi_ranger_x_drift.values[memory->boundedbuffer_abs_multi_ranger_x_drift.current] = new_value;
memory->boundedbuffer_abs_multi_ranger_x_drift.valid[memory->boundedbuffer_abs_multi_ranger_x_drift.current] = 1;
memory->boundedbuffer_abs_multi_ranger_x_drift.is_fresh = 1;
}
void eval_abs_multi_ranger_y_drift_0(Memory* memory){
double new_value = ((multi_ranger_y_drift_sync(memory) < 0)?(-multi_ranger_y_drift_sync(memory)):multi_ranger_y_drift_sync(memory));
memory->boundedbuffer_abs_multi_ranger_y_drift.values[memory->boundedbuffer_abs_multi_ranger_y_drift.current] = new_value;
memory->boundedbuffer_abs_multi_ranger_y_drift.valid[memory->boundedbuffer_abs_multi_ranger_y_drift.current] = 1;
memory->boundedbuffer_abs_multi_ranger_y_drift.is_fresh = 1;
}
void eval_abs_multi_ranger_z_drift_0(Memory* memory){
double new_value = ((multi_ranger_z_drift_sync(memory) < 0)?(-multi_ranger_z_drift_sync(memory)):multi_ranger_z_drift_sync(memory));
memory->boundedbuffer_abs_multi_ranger_z_drift.values[memory->boundedbuffer_abs_multi_ranger_z_drift.current] = new_value;
memory->boundedbuffer_abs_multi_ranger_z_drift.valid[memory->boundedbuffer_abs_multi_ranger_z_drift.current] = 1;
memory->boundedbuffer_abs_multi_ranger_z_drift.is_fresh = 1;
}
...
void eval_multi_ranger_x_drift_exceeded_0(Memory* memory){
bool new_value = (abs_multi_ranger_x_drift_sync(memory) > 0.05);
memory->boundedbuffer_multi_ranger_x_drift_exceeded.values[memory->boundedbuffer_multi_ranger_x_drift_exceeded.current] = new_value;
memory->boundedbuffer_multi_ranger_x_drift_exceeded.valid[memory->boundedbuffer_multi_ranger_x_drift_exceeded.current] = 1;
memory->boundedbuffer_multi_ranger_x_drift_exceeded.is_fresh = 1;
}
...
void eval_multi_ranger_y_drift_exceeded_0(Memory* memory){
bool new_value = (abs_multi_ranger_y_drift_sync(memory) > 0.05);
memory->boundedbuffer_multi_ranger_y_drift_exceeded.values[memory->boundedbuffer_multi_ranger_y_drift_exceeded.current] = new_value;
memory->boundedbuffer_multi_ranger_y_drift_exceeded.valid[memory->boundedbuffer_multi_ranger_y_drift_exceeded.current] = 1;
memory->boundedbuffer_multi_ranger_y_drift_exceeded.is_fresh = 1;
}
...
void eval_multi_ranger_z_drift_exceeded_0(Memory* memory){
bool new_value = (abs_multi_ranger_z_drift_sync(memory) > 0.05);
memory->boundedbuffer_multi_ranger_z_drift_exceeded.values[memory->boundedbuffer_multi_ranger_z_drift_exceeded.current] = new_value;
memory->boundedbuffer_multi_ranger_z_drift_exceeded.valid[memory->boundedbuffer_multi_ranger_z_drift_exceeded.current] = 1;
memory->boundedbuffer_multi_ranger_z_drift_exceeded.is_fresh = 1;
}
...
void shift_abs_multi_ranger_x_drift(Memory* memory){
memory->boundedbuffer_abs_multi_ranger_x_drift.current = (memory->boundedbuffer_abs_multi_ranger_x_drift.current + 1) % 1;
}
void shift_abs_multi_ranger_y_drift(Memory* memory){
memory->boundedbuffer_abs_multi_ranger_y_drift.current = (memory->boundedbuffer_abs_multi_ranger_y_drift.current + 1) % 1;
}
void shift_abs_multi_ranger_z_drift(Memory* memory){
memory->boundedbuffer_abs_multi_ranger_z_drift.current = (memory->boundedbuffer_abs_multi_ranger_z_drift.current + 1) % 1;
}
...
void shift_multi_ranger_x_drift_exceeded(Memory* memory){
memory->boundedbuffer_multi_ranger_x_drift_exceeded.current = (memory->boundedbuffer_multi_ranger_x_drift_exceeded.current + 1) % 1;
}
void shift_trigger_3(Memory* memory){
memory->boundedbuffer_trigger_3.current = (memory->boundedbuffer_trigger_3.current + 1) % 1;
}
void shift_multi_ranger_y_drift_exceeded(Memory* memory){
memory->boundedbuffer_multi_ranger_y_drift_exceeded.current = (memory->boundedbuffer_multi_ranger_y_drift_exceeded.current + 1) % 1;
}
void shift_trigger_4(Memory* memory){
memory->boundedbuffer_trigger_4.current = (memory->boundedbuffer_trigger_4.current + 1) % 1;
}
void shift_multi_ranger_z_drift_exceeded(Memory* memory){
memory->boundedbuffer_multi_ranger_z_drift_exceeded.current = (memory->boundedbuffer_multi_ranger_z_drift_exceeded.current + 1) % 1;
}
...
return multi_ranger_x_drift_exceeded_sync(memory);
}
bool expr_4(Memory* memory){
return multi_ranger_y_drift_exceeded_sync(memory);
}
bool expr_5(Memory* memory){
return multi_ranger_z_drift_exceeded_sync(memory);
}
...
if (abs_multi_ranger_x_drift_is_fresh(memory)) {
verdict.abs_multi_ranger_x_drift = abs_multi_ranger_x_drift_sync(memory);verdict.abs_multi_ranger_x_drift_is_present = 1;
}
if (abs_multi_ranger_y_drift_is_fresh(memory)) {
verdict.abs_multi_ranger_y_drift = abs_multi_ranger_y_drift_sync(memory);verdict.abs_multi_ranger_y_drift_is_present = 1;
}
if (abs_multi_ranger_z_drift_is_fresh(memory)) {
verdict.abs_multi_ranger_z_drift = abs_multi_ranger_z_drift_sync(memory);verdict.abs_multi_ranger_z_drift_is_present = 1;
}
...
if (multi_ranger_x_drift_exceeded_is_fresh(memory)) {
verdict.multi_ranger_x_drift_exceeded = multi_ranger_x_drift_exceeded_sync(memory);verdict.multi_ranger_x_drift_exceeded_is_present = 1;
}
if (trigger_3_is_fresh(memory)) {
verdict.trigger_3 = trigger_3_sync(memory);verdict.trigger_3_is_present = 1;
}
if (multi_ranger_y_drift_exceeded_is_fresh(memory)) {
verdict.multi_ranger_y_drift_exceeded = multi_ranger_y_drift_exceeded_sync(memory);verdict.multi_ranger_y_drift_exceeded_is_present = 1;
}
if (trigger_4_is_fresh(memory)) {
verdict.trigger_4 = trigger_4_sync(memory);verdict.trigger_4_is_present = 1;
}
if (multi_ranger_z_drift_exceeded_is_fresh(memory)) {
verdict.multi_ranger_z_drift_exceeded = multi_ranger_z_drift_exceeded_sync(memory);verdict.multi_ranger_z_drift_exceeded_is_present = 1;
}
...
memory->boundedbuffer_abs_multi_ranger_x_drift.is_fresh = 0;
memory->boundedbuffer_abs_multi_ranger_y_drift.is_fresh = 0;
memory->boundedbuffer_abs_multi_ranger_z_drift.is_fresh = 0;
...
memory->boundedbuffer_multi_ranger_x_drift_exceeded.is_fresh = 0;
memory->boundedbuffer_trigger_3.is_fresh = 0;
memory->boundedbuffer_multi_ranger_y_drift_exceeded.is_fresh = 0;
memory->boundedbuffer_trigger_4.is_fresh = 0;
memory->boundedbuffer_multi_ranger_z_drift_exceeded.is_fresh = 0;
...
if (internalevent.multi_ranger_x_drift_is_present) {
shift_abs_multi_ranger_x_drift(memory);
}
if (internalevent.multi_ranger_y_drift_is_present) {
shift_abs_multi_ranger_y_drift(memory);
}
if (internalevent.multi_ranger_z_drift_is_present) {
shift_abs_multi_ranger_z_drift(memory);
}
if (internalevent.pitch_is_present) {
...
if (internalevent.multi_ranger_x_drift_is_present) {
shift_multi_ranger_x_drift_exceeded(memory);
}
if (internalevent.multi_ranger_y_drift_is_present) {
shift_multi_ranger_y_drift_exceeded(memory);
}
if (internalevent.multi_ranger_z_drift_is_present) {
shift_multi_ranger_z_drift_exceeded(memory);
}
if (internalevent.pitch_is_present) {
...
if (internalevent.multi_ranger_x_drift_is_present) {
eval_abs_multi_ranger_x_drift_0(memory);
}
if (internalevent.multi_ranger_y_drift_is_present) {
eval_abs_multi_ranger_y_drift_0(memory);
}
if (internalevent.multi_ranger_z_drift_is_present) {
eval_abs_multi_ranger_z_drift_0(memory);
}
if (internalevent.pitch_is_present) {
...
if (internalevent.multi_ranger_x_drift_is_present) {
eval_multi_ranger_x_drift_exceeded_0(memory);
}
if (internalevent.multi_ranger_y_drift_is_present) {
eval_multi_ranger_y_drift_exceeded_0(memory);
}
if (internalevent.multi_ranger_z_drift_is_present) {
eval_multi_ranger_z_drift_exceeded_0(memory);
}
if (internalevent.pitch_is_present) {
...
if ((internalevent.multi_ranger_x_drift_is_present && expr_3(memory))) {
shift_trigger_3(memory);
}
if ((internalevent.multi_ranger_y_drift_is_present && expr_4(memory))) {
shift_trigger_4(memory);
}
if ((internalevent.multi_ranger_z_drift_is_present && expr_5(memory))) {
